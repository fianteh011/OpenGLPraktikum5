...
#Sonnenlicht-Intensität
sunIntensity_loc = glGetUniformLocation(programRef, "sunLightIntensity")

#Sonnenlicht-Richtung
sun_loc = glGetUniformLocation(programRef, "sunLightDirection")

#ambientes Licht
ambientLight_loc = glGetUniformLocation(programRef, "ambientLightIntensity")


###AUFGABE 04:
#[NEU:] Ambientes Licht/ Grundbeleuchtung einstellen:
ambientLightIntensity = Matrix.Vec3(0.1, 0.2, 0.9)
glUniform3fv(ambientLight_loc, 1, ambientLightIntensity)

#[NEU:] Sonnenlicht-Intensität einstellen:
sunLightIntensity = Matrix.Vec3(1.0, 1.0, 1.0)
glUniform3fv(sunIntensity_loc, 1, sunLightIntensity)

#[NEU:] Sonnenlicht-Richtung einstellen:
sunLightDirection = Matrix.normalise(Matrix.Vec3(-7.5, 10.0, 5.0))
glUniform3fv(sun_loc, 1, sunLightDirection)
